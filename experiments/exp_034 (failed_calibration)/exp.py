    ...
    for ds_name in datasets:
        ...
        if n_classes_real not in qmoss_models:
            ...
            if not os.path.exists(moss_path):
                ...
                qmoss_isotonic_models[n_classes_real] = None
                ...
                # ================================================
                # 1) QMOSS PURO (SOMENTE SINTÉTICO)
                # ================================================
                ...
                print(
                    f"✅ QMOSS_{n_classes_real} treinado!"
                )

                print(
                    f"✅ QMOSS Feature-Aware Calibration treinado!"
                )
                
                # ==================================================
                # ISOTONIC CALIBRATION DATA
                # ==================================================
                ...
                print(
                    f"🔥 Isotonic samples: {len(pred_matrix)}"
                )

                # ==================================================
                # ONE ISOTONIC PER CLASS
                # ==================================================
                ...
                qmoss_isotonic_models[n_classes_real] = isotonic_models

                print(
                    f"✅ QMOSS Isotonic Calibration treinado!"
                )
        ...
        for idx_batch in tqdm(
            ...
            isotonic_models = qmoss_isotonic_models.get(
                n_classes_real
            )
            ...
            if qmoss_model is not None:
                ...
                try:
                    ...
                    # ------------------------------------------------
                    # FEATURE-AWARE CALIBRATED QMOSS
                    # ------------------------------------------------
                    ...
                    for c in range(n_classes_real):
                        ...
                        p_iso[c] = isotonic_models[c].predict(
                            [p_qmoss[c]]
                        )[0]

                    p_iso = safe_prevalence_vector(
                        p_iso,
                        n_classes_real
                    )
                    ...
                    rows.append({
                        "dataset": ds_name,
                        "modelo": f"QMOSS_{n_classes_real}_ISOTONIC",
                        "n_classes_original": n_classes_real,
                        "erro": np.mean(
                            np.abs(
                                p_iso - p_real
