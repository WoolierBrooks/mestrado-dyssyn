...
OUTPUT_CSV = "m_30_cluster_vs_emq_calibrated.csv"
...
def run_experiment():
    ...
    for ds_name in datasets:
        ...
        # pega o classifier treinado internamente pelo EMQ
        clf = emq.classifier
    ...
    print(
        ...
        f"Resultados salvos em {OUTPUT_CSV}"
    )
